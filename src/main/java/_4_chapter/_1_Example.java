...
/*	Performance in multithreading (Latency):
	The performance in the context of multithreading is measured by two completely independent metrics:
		...
		2) Throughput = the amount of task, completed in a given period. Measured in tasks/time unit.
	Independent means, that one can be improved and the other could not be affected and/or one can be improved while
	worsening the other.
*/
